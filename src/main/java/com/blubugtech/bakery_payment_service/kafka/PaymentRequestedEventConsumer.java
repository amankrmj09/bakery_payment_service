package com.blubugtech.bakery_payment_service.kafka;

import com.blubugtech.common.event.PaymentRequestedEvent;
import com.blubugtech.bakery_payment_service.dto.PaymentRequestDto;
...
public class PaymentRequestedEventConsumer {
    ...
    public void consume(PaymentRequestedEvent event) {
        ...
        try {
            ...
            request.setPaymentMethod(com.blubugtech.bakery_payment_service.entity.Payment.PaymentMethod.valueOf(event.getPaymentMethod()));
